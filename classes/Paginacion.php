...
class Paginacion
{
    public $paginacion_actual;
    public $registros_por_pagina;
    public $total_registros;

    public function __construct($paginacion_actual = 1, $registros_por_pagina = 10, $total_registros = 0)
    {
        $this->paginacion_actual = (int) $paginacion_actual;
    ...
    {
        return $this->registros_por_pagina * ($this->paginacion_actual - 1);
    }
    ...
    {
        $anterior = $this->paginacion_actual - 1;
        return ($anterior > 0) ? $anterior : false;
    }

    public function pagina_siguiente()
    {
        $siguiente = $this->paginacion_actual + 1;
